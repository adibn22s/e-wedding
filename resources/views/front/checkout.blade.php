    ...
    <div id="checkout-section" class="max-w-[1200px] mx-auto w-full min-h-[calc(100vh-40px)] flex flex-col gap-[30px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-t-[32px] overflow-hidden relative pb-6">
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
            <div class="w-[400px] flex shrink-0 flex-col bg-white rounded-2xl p-5 gap-4 h-fit">
                ...
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col gap-[2px]">
                            <p class="font-semibold">{{ $catalogue->name }}</p>
                        </div>
                    </div>
                ...
                <p class="font-semibold text-[28px] leading-[42px]">{{ formatRupiah($catalogue->price) }}</p>
            </div>
            <form action="{{ route('front.checkout.store', $catalogue->id) }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5">
                @csrf
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">{{ $catalogue->vendor->name }}</p>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">{{ $catalogue->vendor->account_number }}</p>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">{{ $catalogue->vendor->bank_name }}</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex gap-3">
                            ...
                            <p class="text-[#475466]">DP 50%</p>
                        </div>
                        <p class="font-semibold">{{ formatRupiah($catalogue->price / 2) }}</p>
                ...
                <div class="relative p-4 rounded-full flex gap-3 w-full ring-1 ring-black transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">
                    <p id="fileLabel">Choose Your Date</p>
                    <input id="dateInput" type="date" name="book_date" class="mt-1 w-full sm:text-sm">
                </div>
